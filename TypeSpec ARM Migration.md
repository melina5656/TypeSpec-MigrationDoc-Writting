...
> Note:
It should have some changes for the sorted swagger, but it should not be committed finally.
...
- x-ms-pageable missing
  ...
  ![alt text](images/1742968313174.png)
...
- x-ms-enum name missing
  ...
  ![alt text](images/1742977297506.png)
...
- Response 202
  ...
  ![alt text](images/1742973050451.png)
-----
