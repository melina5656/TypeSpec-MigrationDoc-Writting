...
- [TypeSpec ARM Migration](#typespec-arm-migration)
  ...
  - [9. Generate SDK from TSP And fix SDK differences](#9-generate-sdk-from-tsp-and-fix-sdk-differences)
    ...
    - [9.3 Generate code](#93-generate-code)
    - [9.4 Fix SDK diffs](#94-fix-sdk-diffs)
<!-- /TOC -->
---
...
Please run command like: `dotnet build /t:GenerateCode /p:LocalSpecRepo="D:\Lwm\SourceCode\azure-rest-api-specs\specification\storage\Storage.Management\"`
